...
describe('improvingItem', () => {
  it('should decrease sellIn by 1', () => {
    const item = new ImprovingItem(new Item('Test Item', 10, 20))
    item.updateQuality()
  ...
  it('should not increase quality above MAXIMUM_QUALITY', () => {
    const item = new ImprovingItem(new Item('Test Item', 10, MAXIMUM_QUALITY))
    item.updateQuality()
  ...
  it('should clamp initial invalid quality between MINIMUM_QUALITY and MAXIMUM_QUALITY', () => {
    const item = new ImprovingItem(new Item('Test Item', 10, MINIMUM_QUALITY - 10))
    item.updateQuality()
    expect(item.quality).toBe(MINIMUM_QUALITY)

    const item2 = new ImprovingItem(new Item('Test Item', 10, MAXIMUM_QUALITY + 10))
    item2.updateQuality()
